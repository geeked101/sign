...
// Sign dictionary - maps words to GIF/image URLs
...
export default function App() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.signBox}>
        {currentSign ? (
          ...
          <Text style={styles.placeholder}>
            {currentWord
              ? `❓ No sign yet for "${currentWord}"`
              : 'Speak to see signs here'}
          </Text>
        )}
      </View>
      ...
      {listening && (
        <Text style={styles.hint}>Listening... speak clearly</Text>
      )}
    </SafeAreaView>
  );
}
